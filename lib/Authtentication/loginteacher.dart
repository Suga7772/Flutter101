...
import 'package:sqlite_flutter_crud/Authtentication/signupteacher.dart';
...
class _loginTeacherState extends State<loginTeacher> {
  ...
  loginT() async {
    var response = await db.loginT(
        Teacher(TusrName: Tusername.text, TusrPassword: Tpassword.text));
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      const Text("You are not teacher?"),
                      TextButton(
                          onPressed: () {
                            //Navigate to sign up
                            Navigator.push(
